...
\[
\infer[\eta^+_p]
{\foct{\Psi}{\frameoff{\Theta}{p^+_p}}{\tetapp{z}{N}}{U}}
{\foct{\Psi}{\tackon{\Theta}{z{:}\ispers{\langle p^+_p \rangle}}}{N}{U}}
\quad
\infer[\eta^+_l]
{\foct{\Psi}{\frameoff{\Theta}{p^+_l}}{\tetapl{z}{N}}{U}}
{\foct{\Psi}{\tackon{\Theta}{z{:}\iseph{\langle p^+_l \rangle}}}{N}{U}}
\quad
\infer[\eta^+]
{\foct{\Psi}{\frameoff{\Theta}{p^+}}{\tetap{z}{N}}{U}}
{\foct{\Psi}{\tackon{\Theta}{z{:}\istrue{\langle p^+ \rangle}}}{N}{U}}
\]
\vspace{-5pt}
\[
\infer[{\it id}^+]
{\foct{\Psi}{\Delta}{x}{[A^+]}}
{x{:}\langle A^+ \rangle \subseteq \Delta}
\quad
\infer[\eta^-]
{\foct{\Psi}{\Delta}{\langle N \rangle}{p^-}}
{\foct{\Psi}{\Delta}{N}{\istrue{\langle p^- \rangle}}}
\quad
\infer[{\it id}^-]
...
\quad
\infer[{\oplus}_{R1}]
{\foct{\Psi}{\Delta}{\tinl{V}}{[A^+ \otimes B^+]}}
{\foct{\Psi}{\Delta}{V}{[A^+]}}
\quad
\infer[{\oplus}_{R2}]
{\foct{\Psi}{\Delta}{\tinr{V}}{[A^+ \otimes B^+]}}
{\foct{\Psi}{\Delta}{V}{[B^+]}}
\]
\vspace{-5pt}
\[
...
\quad
\infer[{\one}_R]
{\foct{\Psi}{\cdot}{\toner}{[\one]}}
{}
\quad
\infer[{\one}_L]
{\foct{\Psi}{\frameoff{\Theta}{\one}}{\tonel{N}}{U}}
{\foct{\Psi}{\tackon{\Theta}{\one}}{N}{U}}
\]
\vspace{-5pt}
\[
\infer[{\otimes}_R]
{\foct{\Psi}{\Delta_1, \Delta_2}{\ttensorr{V_1}{V_2}}{[A^+ \otimes B^+]}}
{\foct{\Psi}{\Delta_1}{V_1}{[A^+]}
 &
 \foct{\Psi}{\Delta_2}{V_2}{[B^+]}}
\quad
\infer[{\otimes}_L]
{\foct{\Psi}{\frameoff{\Theta}{A^+ \otimes B^+}}{\ttensorl{N}}{U}}
{\foct{\Psi}{\tackon{\Theta}{A^+, B^+}}{N}{U}}
\]
\vspace{-5pt}
\[
\infer[]
{\foct{\Psi}{\Delta}{\tlamr{N}}{A^+ \righti B^-}}
{\foct{\Psi}{\Delta, A^+}{N}{B^-}}
\quad
\infer[]
{\foct{\Psi}{\frameoff{\Theta}{[A \righti B], \Delta_A}}{\tappr{V}{\Sp}}{U}}
...
{\foct{\Psi}{A^+,\Delta}{N}{B^-}}
\]
\vspace{-5pt}
\[
\]}
\caption{a a a a a a a a a a a a a a a 
