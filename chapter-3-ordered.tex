...
${!}p^+_\mpers$.\footnote{The polarity and level annotations are
  meaningless in the unfocused logic. We keep them only to empahsize
...
critera from our previous work
\cite{simmons08linear,pfenning09substructural} arising as an emergent
phenomena of erasure.

Succeedents $\istrue{A^+}$ and $\islax{A^+}$ erase simply to 
$\istrue{(A^+)^\circ}$ and $\islax{(A^+)^\circ}$, respectively, and
suspended atomic succeedents $\islvl{\susp{p^-_\mlvl}}$ likewise erase
...
$\Psi; \Delta^\circ \Rightarrow U^\circ$. We will proceed in this manner,
tacity assuming the eqivalence of these two presentations of
unfocused \ollll.
...
The act of taking a focused proof of a sequent and getting
a focused proof of the corresponding erased sequent is {\it de-focalization},
and the proof of the soundness of focusing (the \ollll~analouge of 
...
from the discussion in the proof of focalization for 
linear logic (Theorem~\ref{thm:linfoccomplete} in 
Section~\ref{sec:lincorrectness}) 
