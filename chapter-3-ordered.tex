...
Our ability to imagine proof terms as being fully independently typed
...
\item[--] $\rsubsta{M}{x}{(\tfocusl{x}{\Sp})}{A^-} =$\\
    ...
    \end{array}$\smallskip\\
  We must show $\foc{\Psi}{\Xi}{}$
  \begin{itemize}
  \item $M$ is a derivation of $\foc{\Psi}{\Delta}{A^-}$, 
  \item $\tackon{\Theta}{x{:}\islvl{A^-}}$ matches
     $\frameoff{\Theta'}{[A^-]}$, 
     $\Sp$ is a derivaiton of 
     $\foc{\Psi}{\tackon{\Theta'}{[A^-]}}{U}$,
  \item and $\Xi$ matches $\frameoff{\Theta}{\restrictto{\Delta}{\mlvl}}$.
  \end{itemize}
  ...
  If $\mlvl$ is $\mpers$, then there is a $\Delta'$ XXXX
...
\item[--] $\rsubsta{M}{x}{(\tdownl{x}{N})}{A^-} 
           = \tdownl{x}{(\rsubsta{M}{x}{N}{A^-})}$
\item[--] $\rsubsta{M}{x}{(\tgnabl{x}{N})}{A^-} 
           = \tgnabl{x}{(\rsubsta{M}{x}{N}{A^-})}$
\item[--] $\rsubsta{M}{x}{(\tbangl{x}{N})}{A^-} 
           = \tbangl{x}{(\rsubsta{M}{x}{N}{A^-})}$
