...
\[
\infer[\eta^+_\mlvl]
{\foct{\Psi}{\frameoff{\Theta}{p^+_\mlvl}}{x.N}{U}}
{\foct{\Psi}{\tackon{\Theta}{x{:}\islvl{\langle p^+_\mlvl \rangle}}}{N}{U}}
\qquad
\infer[{\it id}^+]
{\foct{\Psi}{\Delta}{x}{[A^+]}}
...
\infer[\eta^-]
{\foct{\Psi}{\Delta}{N}{p^-}}
{\foct{}{}{N}{\istrue{\langle p^- \rangle}}}
\]
\end{figure}

\begin{align}
V & ::= \\
N & ::= \tfocusr{V} \mid \tfocusl{x}{\Sp} \mid x.N \\
S & ::= 
\end{align}
