...
\ollll~is in keeping with as Andreoli's insistance that we should
...
presentation to the affine modality or to the subexponentials
discussed by Nigam and Miller \cite{nigam09algorithmic}, and it should
be reasonably straightfoward to extend our presentation to richer
...
The use of proof terms also allows for a greatly compressed
presentation of cut admissibility and identity expansion, though much
...
explicit in proofs like the cut admissibility theorem.  Furthermore,
we will reuse much of this notation in our formulation of a logical
...
Conjecture: the suitibilty of the framing-off operation 
