...
Our treatment of first-order unification means that we need to prove a
variable substitution theorem, Theorem~\ref{thm:varsubst}. 
...
\paragraph{First-order fragment}
