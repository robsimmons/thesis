...
\ollll. We will use this to informally motivate our notation,
...
of substructural contexts. Formally, we will represent frames in
...
We can use frames to build contexts: the operation
