...
\item[--] $(\subst{z}{\tetap{z'}{N}})^{p^+_{\mlvl}} = [z/z']N$\\
  ...
  \begin{itemize}
   ...
   \item $\tackon{\Theta}{p^+}$ matches $\frameoff{\Theta'}{p^+}$,
      ...
      $\foc{\Psi}{\tackon{\Theta'}{z'{:}\islvl{\susp{p^+_\mlvl}}}}{U}$, and
   \item $\Xi$ matches $\frameoff{\Theta}{\Delta}$.
  \end{itemize}
...
%         $N$ is a derivation of 
%         $\foc{\Psi}{\tackon{\Theta'}{x{:}\istrue{A^-}}}{U}$, and
%   \item $\Xi$ matches $\frameoff{\Theta}{\Delta}$.
%   \end{itemize}
...
\item[--] $(\subst{\tbangr{M}}{\tbangl{x}{N}})^{{!}A^-}
  ...
  We must show $\foc{\Psi}{\Xi}{U}$, where
  \begin{itemize}
  \item $M$ is derivation of $\foc{\Psi}{\Delta'}{A^-}$, 
        $\Delta$ matches $\restrictto{\Delta'}{\mpers}$, $\Delta'$ is stable,
  \item $\tackon{\Theta}{{\downarrow}A^-}$ matches 
        $\frameoff{\Theta'}{{\downarrow}A^-}$,
        $N$ is a derivation of 
        $\foc{\Psi}{\tackon{\Theta'}{x{:}\istrue{A^-}}}{U}$, and
