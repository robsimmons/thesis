...
Proving cut admissibility under our treatment of first-order unification
will require us to prove that we can apply a first-order substitution to
a derivation and still have a valid derivation. At the level of proof terms,
the constructive content of the variable substitution theorem, 
Theorem~\ref{thm:varsubst}, is $\sigma{E}$ 
...
applying $\sigma' \circ \sigma$ to $\psi$.

$\sigma(\tforallr{x}{N}) = \tforallr{x}{(\sigma, x/x)N}$
...
Assume an aribtrary such $\Psi'''$ and $\sigma$, and note that
$\foc{\Psi'''}{\tackon{\sigma'(\sigma \Theta)}{\cdot}}{\sigma'(\sigma U)}$
