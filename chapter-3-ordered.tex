...
$\Xi$ maches $\frameoff{\Theta}{\Delta}$ and
...
the action of the left rule, read bottom-up, is observe that  
$\tackon{\Theta}{x{:}\islvl{A^-}}$ matches 
$\frameoff{\Theta'}{y{:}\istrue{T}}$ in its conclusion and constructs 
$\frameoff{\Theta'}{y{:}\islvl{T'}'}$ in its premise. 
...
\item[--] $\rsubsta{M}{x}{(\tbangl{y}{N})}{A^-} 
  ...
  $\frameoff{\Theta_B}{\restrictto{\Delta'}{\mlvl}}$,
  and 
  $\tackon{\Theta_B}{x{:}\islvl{A^-}} = \tackon{\Theta'}{y{:}\ispers{B^-}}$.
  By the induction hypothesis on $M$ and $N$ we have
