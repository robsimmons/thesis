...
framework in Chapter 4. The full focusing system for ordered
...
frameworks as well as for logic programming langauges.\footnote{Indeed,
as Lolli, Twelf, Lollimon, Forum, and Celf show, logical
