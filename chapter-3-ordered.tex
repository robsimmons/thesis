...
\noindent
The four cases of cut admissibility neatly codify an observation about
the structure of cut admissibility proofs first made by Pfenning in
his work on structural cut elimination \cite{pfenning00structural}.
The first two parts of Theorem~\ref{thm:ord-cut} are the home of the
{\it principal cases} that decompose both derivations simultaneously,
the third part contains all the {\it left commutative cases} that
break apart only the first given derivation, and the fourth part
contains all the {\it right commutative cases} that break apart only
...
This statement of cut admissibility has four parts. 
...
A final improvement in our theorem statement is very subtle: the {\it
  particular} fixed inversion strategy we chose matters somewhat.  The
use of a fixed inversion strategy is critical to avoid two problems
with Theorem~\ref{thm:lincut}. The more serious problem, dicussed in
