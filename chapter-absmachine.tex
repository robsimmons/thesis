...
but directional assignment is (as usuall) somewhat arbitrary. 
...
\item If $\Delta$ matches $\frameoff{\opsubst{\Theta}}{\opsubst{\Gamma}}$ and
$(\Psi; \frameoff{\opsubst{\Theta}}{x{:}\susp{{\sf eval\_a}\,t}}) \leadsto^*_{\transop{\Sigma}} (\Psi; z{:}\susp{{\sf retn\_z}\,t_z})$, then there exists an $s$ such that
$\slss{\Sigma}{\Psi}{\Gamma}{\susp{{\sf ac}\,t\,s}}$ and
$(\Psi; \tackon{\opsubst{\Theta}}{y{:}\susp{{\sf retn\_a}\,s}}) 
   \leadsto^*_{\transop{\Sigma}}
 (\Psi; \mkconj{\Gamma}{z{:}{\sf retn\_z}\,t_z})$.
\end{enumerate}
\end{theorem}
...
\begin{tabbing}
$T :: (\Psi; \Gamma, x{:}\susp{{\sf eval\_a}\,t_1}) \leadsto^*_{\transop{\Sigma}} (\Psi; \Gamma, y{:}\susp{{\sf retn\_a}\,t_2})$
 \` (given)
\\
...
$T' :: (\Psi; \Gamma, y'{:}\susp{{\sf retn\_a}\,s})
         \leadsto^*_{\transop{\Sigma}}
       (\Psi; \Gamma, y{:}\susp{{\sf retna\_a}\,t_2})$
 \` (ind. hyp. (part 4) on $T$)
\\
