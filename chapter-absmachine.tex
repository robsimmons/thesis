...
\item There is a bijection between contexts $\Delta$ such that
  $x{:}\susp{\sf gen} \leadsto_{\Sigma\sf gen} \Delta$ where ${\sf gen} \notin \Delta$
  and states $s$.
\item There is a bijection between frames $\Theta$ such that $x{:}\susp{\sf
    gen} \leadsto_{\Sigma\sf gen} \tackon{\Theta}{x'{:}{\sf gen}}$ and
  stacks $k$.
\end{itemize}
\end{theorem}
...
\\ \>\> $~ :: ~$ 
  \> $x{:}\susp{\sf gen} 
       \leadsto^* \tackon{\Theta}{x'{:}\susp{\sf gen}} 
       \leadsto \tackon{\Theta}{z{:}\susp{{\sf eval}\,\interp{e}}}$
\\[4pt]
...
\\ \>\> $~ :: ~$ 
  \> $x{:}{\sf gen} 
       \leadsto^* \tackon{\Theta}{x'{:}\susp{\sf gen}} 
       \leadsto \tackon{\Theta}{z{:}\susp{{\sf retn}\,\interp{v}}}$
\\[4pt]
...
\subsection{Preservation of adequacy}
