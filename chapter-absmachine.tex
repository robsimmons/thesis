...
If $\Theta$ contains only atomic propositions, persistent propositions
 ...
 {\matchconj
  ...
  {\matchconj
    ...
    {\matchconj 
      ...
      {y{:}{(\forall \overline{x}\,{\sf retn\_b1},s_1 \fuse \ldots \fuse {\sf retn\_bn}\,s_n \lefti S)}}}}}$ and $T :: \Delta \leadsto^*_{\transop{\Sigma}}
{\sf retn\_x}\,t_x$, then $T \equiv \tstep{p}{y}{\Sp}; T'$.
\item If $\Delta$ matches
$\frameoff{\Theta}
 {x{:}\susp{{\sf eval\_b}\,t_1}}$ and $T :: \Delta \leadsto^*_{\transop{\Sigma}}
{\sf retn\_x}\,t_x$, then $T \equiv \tstep{p}{\sf r}{\Sp}; T'$. 
\end{enumerate}
\end{theorem}
