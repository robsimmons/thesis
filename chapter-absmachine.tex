...
This chapter presents two transformations on logical specifications.
The first is operationalization, which interprets a limited set of
...
\begin{align*}
{\sf abs/lam}{:} & ~~ k \rhd \lambda x.e ~ \mapsto ~ k \lhd \lambda x.e
\\
{\sf abs/app}{:} & ~~ k \rhd e_1\,e_2 ~ \mapsto ~ (k; \Box\,e_2) \rhd e_1
\\
{\sf abs/app1}{:} & ~~ 
