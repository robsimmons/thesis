...
%
In Section~\ref{sec:sls-adequate} we discussed the methadology of 
...
structure of a context-free grammar like the CFG that encoded
...
and $\restrictsig{\Delta}{\Sigma\ref{fig:cbv-ev-ssos-fun}}$.
\end{theorem}
\bigskip

The proof of Theorem~\ref{thm:adequacy-states} follows the structure
of Theorem~\ref{thm:pda-encoding}: we first define a context encoding function
\smallskip
\begin{itemize}
...
\end{itemize}
\smallskip
While it is simple to observe that the encoding function is injective 
