...
When we described the semantics of nondeterminstic choice $e_1 \arb e_2$,


Our intention in describing the semantics of nondeterminstic choice

The factoring transformation reduces or eliminated the need for
backtracking in computation. 
