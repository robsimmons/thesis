...
\begin{figure}[t]
\begin{align*}
x_1{:}\susp{{\sf p_2}(\lf{\sf c})}, ~
x_2{:}\susp{{\sf p_1}(\lf{\sf c})}, ~
...
x_4{:}\istrue{({\sf p_3}(\lf{\sf c}) \lefti \{ {\sf p_4} \})} & \\
\leadsto ~~ 
x_6{:}\susp{{\sf p_3}(\lf{\sf c})}, ~
x_4{:}\istrue{({\sf p_3}(\lf{\sf c}) \lefti \{ {\sf p_4} \})} & \\
\leadsto ~~ 
x_7{:}\susp{{\sf p_4}} & 
\end{align*}
\caption{Evolution of a nested \sls~process state (${\sf p_1}$, ${\sf
  p_2}$ and ${\sf p_3}$ are all ordered atomic propositions).}
\label{fig:ho-evo-ex}
\end{figure}
...
Related work for program analyses methodology covered in Chapter~8 is
