...
\noindent
Each of these three styles is, in a very formal sense, more expressive
...
called {\it operationalization}. The transformation from natural
...
\sls~specifications, on the other hand, contain {\it rules} in the
