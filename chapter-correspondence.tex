...
his methadology to reason about safety. 
...
computations as concurrent traces.
...
definition, Leroy and Grall prove a type safety propety: if $e$ has
...
unsuprising that type safety is proved classically by Leroy and Grall.

We suggest that the operationalization transformation is superior to
the coinductive (re)interpreation as a way of understanding the 
behavior of infinite terms in the natural semantics. 
