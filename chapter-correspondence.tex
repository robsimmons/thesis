...
\sls~specifications that {\it operationalizes} deductive proof search
as concurrent proof search.
...
core of the idea that we will use to classify 
 ...
 In order
to make sense of the design space of substructural operational
semantics, we need some design principles that allow us to both {\it
  classify} different styles of presentation and {\it predict} what
style(s) we should adopt based on what our goals are.  The organizing
principle that we put forth in this chapter and the next one is called
the {\it logical correspondence}, in analogy.
