...
A candidate for a more primitive logic, and one that has formed the
basis of much of my previous work on logic programming in
substructural logic
...
There are effectively two different focused derivations of this
sequent, the one that transitions $\langle a^+ \rangle$ to $\langle
b^+ \rangle$ first, and the one that transitions 
$\langle c^+ \rangle$ to $\langle d^+ \rangle$ first:
\[
\infer[{\sf CP}_{a^+ \lolli {\uparrow}b^+}]
{\mildseq{a^+ \lolli {\uparrow}b^+, ~
  c^+ \lolli {\uparrow}d^+ ~~}
  ...
  ~~}
  {~~b^+ \otimes d^+}}
{\infer[{\sf CP}_{c^+ \lolli {\uparrow}d^+}]
{\mildseq{a^+ \lolli {\uparrow}b^+, ~
  c^+ \lolli {\uparrow}d^+ ~~}
  {~~
  \langle b^+ \rangle,~
