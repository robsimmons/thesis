...
Cut admissibility for this focused linear logic is mostly standard, so
we defer a discussion to the next chapter, where the use of structural
focalization will allow us to give a tidier proof of the theorem.
...
The proof of this theorem is not quite as tidy as the 
