...
logic. We can achieve that goal with or without the use of
polarization, but the use of polarized logic simplifies the proof of
...
focusing for an explicitly polarized presentation of intuitionistic
linear logic.
...
\cite{pfenning12chaining} and which Laurent calls a {\it weakly
  ...
  a different sort of logic weakly focused  in \cite{simmons11weak}. 
  That weakly
