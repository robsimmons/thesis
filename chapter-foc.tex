...
natural polarization strategy to contexts and succeedents, which is
...
\begin{proof}
        ...
        {\infer[{\lolli}_L]
         ...
         {\infer[{\downarrow}_R]
          {\mildseq{\Gamma^\ominus}{\langle A^\oplus \rangle}
           {[{\downarrow}{\uparrow}A^\oplus]}}
          {\infer[{\uparrow}_R]
           {\mildseq{\Gamma^\ominus}{\langle A^+ \rangle}{{\uparrow}A^+}}
           {\infer[{\it focus}_R]
            {\mildseq{\Gamma^\ominus}{\langle A^+ \rangle}{A^+}} 
            {\infer[{\it id}^+]
             {\mildseq{\Gamma^\ominus}{\langle A^+ \rangle}{[A^+]}}
             {}}}}
          &
  ...
  Either $B$ is a right-asychronous connective, in which case
