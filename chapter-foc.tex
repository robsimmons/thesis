...
derivation of $(A^+)^\circ$ or $(A^-)^\circ$ if and only if there is a focused
derivation of $A^+$ or $A^-$.  However, most proofs of the correctness of
...
$\underline{\Delta}$ or $\underline{U}$ to indicate when $\Delta$
may contain a focus $[A^-]$ and when $U$ may be a focus $[A^+]$. 
Pfenning, who developed this construction
in \cite{pfenning12chaining}, calls this the 
{\it focusing constraint}, and writes $\delta$ and $\gamma$ instead 
of $\Delta$ and $U$.
...
Within\ldots FIX THIS.

 parts 3, 4, and 5, the first two metrics stay the same
while either the derivation gets smaller and the second stays the same,
or the 
