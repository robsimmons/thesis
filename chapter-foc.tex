...
fundamentally change the structure of the rest of the proof. This is 
a property we would already need to prove {\it unfocused cut}, which
is expressed by the following admissibile rule, where $A$ is $A^+$
...
Theorem~\ref{thm:lincut} applies. This unfocused cut rule is
...
Given the decidability of this 

this decidable equivalence on proofs, we can pick some member of
