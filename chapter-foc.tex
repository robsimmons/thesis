...
on,\robnote{reconsider} we will turn our attention to suspended
...
lemmas work.
  ...
  $A^-$ such that $C^- =
  {\uparrow}{\downarrow}\ldots{\downarrow}{\uparrow}{!}A^-$.\robnote{Add
    a footnote here explaining what is going on.}  By the induction
...
Our\robnote{Re-introduce why we're doing this.} final attempt to
