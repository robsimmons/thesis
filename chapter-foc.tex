...
considered to be the {\it mulitplicative} connectives, and the
connective ${!}A$ is the {\it exponential} connective of intuitionstic
linear logic.\footnote{In this chapter we will mostly ignore the {\it
    additive} connectives of intuitionstic linear logic $\zero$, $A
  ...
  intuitionstic linear logic \cite{chang03judgmental}, but I will not
...
Focalization development, I discuss how, if we encode the focused
...
Focalization development.\footnote{The main ``untidy'' aspect of
  ...
  identitical in form to the proof of part 5, a defect that will also
...
Theorem~\ref{thm:linfocomplete}. There is indeed only one 
...
logic with ${\pbang}p^+$. 
The most of the new cases are unproblematic,
