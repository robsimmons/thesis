...
Despite the novel treatement of suspended propositions in
...
intuitionstic analouge to Andreoli's original presentation of focusing
\cite{andreoli92logic}, as Pfenning's course notes is
\cite{pfenning12chaining}.\footnote{We will blur the lines, in this
  section, between Androli's original presentation of focused
  classical linear logic and Pfenning's adaptation to intuitionstic
...
language of ordered logical specefications presented by Pfenning and I
\cite{pfenning09substructural}.

The difference, in each case, lies in the treatment of positive atomic
propositions, which can be a suprisingly rich source of fungible
...
All three of these options are essentially similar;
...
in the first proposied alternative, ${!}_{L2}$ in the second proposed
...
When we substitue a positive atomic proposition $A^+$ for a positive
...
into the linear context and decompose it, one for each occurance of
${\it id}^+_p$ for a substituted proposition in the focusing phase.
One instance of this pheonemna 
...
Anderoli's focusing system exhibits the same issues. It is probably
for this reason that there is very little discussion of the menaing of
