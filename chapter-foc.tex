...
Our treatment of identity expansion suggests that focused linear logic
without the atom or bang optimizations is the most natural focused
variant of pure linear logic. The structure of the atom and bang
optimziations points towards the existance of more expressive logics
in which linear logic can be embedded in a way that is faithful to
either the natural focusing system or to the various modifications to
focusing that we have discussed. Both Benton and Wadler's adjoint
logic and Melli{\`e}s and Tabareu's tensor logic are reasonable
candidate systems and deserve further consideration, but this
