...
the left or the right, when read from bottom to top. 
...
Within part 3, the first two
metrics stay the same while the first given derivation gets smaller,
and within parts 4 and 5, the first two metrics stay the same while the
...
a unfocused proof of $(A^+)^\circ$ if and only if there is a focused proof of
$A^+$. The proof require lifting of our erasure function 
...
lemmas work.
  ...
  $\mildseq{\Gamma, A^-}{\Delta, A^-}{C}$, and we conclude
  ...
  $C^- = 
   ({\uparrow}{\downarrow}\ldots{\uparrow}{\downarrow}(A^+ \lolli B^-))^\circ$.
  ...
  $B^-$ such that $A = (A^+)^\circ$, $B = (B^-)^\circ$, and 
  $C^+ = 
   ({\downarrow}{\uparrow}{\downarrow}\ldots{\uparrow}{\downarrow}
    (A^+ \lolli B^-))^\circ$.
  By the induction hypothesis, we have
  ...
  \[
  \infer=[]
  {\mildseq{\Gamma}{\Delta}{{\downarrow}{\uparrow}{\downarrow}\ldots{\uparrow}{\downarrow}
    (A^+ \lolli B^-)}}
  {\infer-[{\it cut}(4)]
