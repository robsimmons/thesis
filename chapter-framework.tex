...
trace computation is nonstandard. Furthermore, we have left out
several important classes of deductive computation, like tabled logic
programming and breadth-first goal-oriented search. (The goal-oriented
search we have described is depth-first.)
