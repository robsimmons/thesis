...
The first cut insufficent due to the presence of unification
...
succeedent $\islax{A^+}$ instead of $\islax{({\sf
...
coarser than the equvalence relation we would derive from partial
