...
The \sls~implementation also supports standard abbreviations for
...
\verb|A -o B|, and so on.

Another significant piece of syntactic sugar is used for 
the sake of readability: if \verb|P| is a
