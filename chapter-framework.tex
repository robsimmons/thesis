...
implementation \cite{schacknielsen08celf}. This interpretation 
was part of our motivation 

 of the motivation behind separating the structure of deductive
\sls~proofs -- that is, proofs of $\istrue{\susp{p^-}}$ -- from the structure of traces,
partial proofs of $\islax{A^+}$, 
