...
It should not be terribly suprising that the generative invariant for
...
If $T_1 :: \left(\lf{d_0}{:}{\sf dest}; x_0{:}\ispers{\susp{{\sf
          ofdest}\,\lf{d_0}\,\lf{{\it tp}_0}}}, z{:}\iseph{\susp{{\sf
          gen}}}\right) \leadsto^*_{\siggenletcc} \left(\Psi; \Delta \right)$
...
\bigskip
\begin{theorem}
  If $T :: \left(\lf{d_0}{:}{\sf dest}; x_0{:}\ispers{\susp{{\sf
          ofdest}\,\lf{d_0}\,\lf{{\it tp}_0}}}, z{:}{\sf gen}\right)
  \leadsto \left(\Psi; \Delta\right)$, then every $d{:}{\sf dest} \in
  \Psi$ can be associated uniquely with a stack $\obj{k} =
  \obj{((\ldots({\sf halt}; f_1); \ldots) f_n)}$
\end{theorem}
