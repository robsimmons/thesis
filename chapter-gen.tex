...
\\ then $T = (T'; \trstep{y}{{\sf gencell/fulfill}\,\lf{l}\,\lf{\it tp}\,\lf{v}\,(\tfuser{x'}{\tfuser{\tbangr{N}}{\tbangr{N_v}}})})$,
\\ where $\Psi; \Delta \vdash_{\siggenstate} N : {\sf of}\,\lf{v}\,\lf{\it tp}$,
   $\Psi; \Delta \vdash_{\siggenstate} N_v : {\sf value}\,\lf{v}$,
\\ $T' :: (\cdot; x{:}\iseph{\susp{{\sf gen}\,\lf{{\it tp}_0}\,\lf{d_0}}})
       \leadsto^*_{\siggenstate}
       (\Psi'; \tackon{\Theta}
          {x'{:}\istrue{\susp{{\sf gencell}\,\lf{l}\,\lf{\it tp}}}})$,
\\ and $\Delta$ is the persistent part of 
   $\tackon{\Theta}
          {x'{:}\iseph{\susp{{\sf gencell}\,\lf{l}\,\lf{\it tp}}}}$.
\end{enumerate}
\end{lemma}
\bigskip
...
of these theorems.
The new inversion lemma (part 3 above) also follows the same
