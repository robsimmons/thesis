...
The basic structure of existing inversion lemmas remain unchanged, but 
these lemmas 
must be modified to deal with the fact that derivations and
...
$\ispers{{\sf ofcell}\,\lf{l}\,\lf{\it tp}}$. This purely persistent
world fits the pattern of regular worlds. As such, it can be described either with the
single rule
...
The only new inversion lemma that is needed is the one listed 
