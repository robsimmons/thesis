...
rather, our main empahsis is in the represetnation of the operational
semantics of programming languages. We can represent operational
semantics in \sls~in many ways, most of are in a broad specification
style called {\it substructural operational semantics}, or
SSOS.\footnote{The term {\it substructural operational semantics} is a
  bit of a portmanteau, merging structural operational semantics
...
abstract machines, and logical specifications where machine states are
represented by collections of atomic propositions.
