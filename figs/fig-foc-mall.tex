...
\infer[{\it id}^+]
{\foct{\Psi}{\Delta}{z}{[A^+]}}
{\Delta~\mbox{\it matches}~z{:}\langle A^+ \rangle \mathstrut}
\]
\vspace{-5pt}
\[
\infer[\eta^-]
...
\quad
\infer[{\it id}^-]
{\foct{\Psi}{\Delta}{\tnil}{\islvl{\susp{A^-}}}}
...
\[
\infer[{\one}_R]
{\foct{\Psi}{\Delta}{\toner}{[\one]}}
{\Delta~\mbox{\it matches}~\matchunit \mathstrut}
\quad
\infer[{\one}_L]
...
{\foct{\Psi}{\Delta_A}{V}{[A^+]}
 ...
 \foct{\Psi}{\tackon{\Theta}{[B]}}{\Sp}{U}}
\]
\caption{Multiplicative, exponential fragment of focused
  \ollll~(contexts $\Psi$ suppressed)}
\label{fig:foc-mall}
\end{figure}
