...
\newcommand{\arb}{\mathbin{??}}
\newcommand{\interp}[1]{{\ulcorner{#1}\urcorner}}

\newcommand{\transbasic}[1]{{\it OB}({#1})}
\newcommand{\transtail}[1]{{\it OT}({#1})}
\newcommand{\transpar}[1]{{\it OP}({#1})}

\newcommand{\opbasic}[3]{\llbracket {#1} \rrbracket({#2},{#3})}